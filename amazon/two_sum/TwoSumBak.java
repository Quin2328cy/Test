...
public class TwoSumBak {
    ...
    public List<List<Integer>> TwoSum(List<List<Integer>> list1, List<List<Integer>> list2, int max_load) {
        ...
        int right_value = 0; //l2_temp.get(1);
        System.out.println("right = " + right_value);
//        int left_pointer = 0;
//        int right_pointer = list2.size();
        //left_pointer < list1.size() && right_pointer > 0 &&
...
//                }
    ...
    public static void main(String[] args) {
        TwoSumComplicate twoSum = new TwoSumComplicate();
        ...
        List<List<Integer>> res = twoSum.TwoSum(l1, l2, 10000);
